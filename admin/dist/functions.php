...
function countCategories()
{
    ...
    $sum = 0;
    $query_cat_count = "SELECT * FROM categories";
    $count_cats_query = mysqli_query($connection, $query_cat_count);
    $cats['all'] = mysqli_num_rows($count_cats_query);


    while ($row = mysqli_fetch_assoc($count_cats_query)) {
